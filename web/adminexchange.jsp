...
<div id="templatemo_container">
    ...
    <%
        try {
        PreparedStatement ps = connection.prepareStatement("select * from exchange");
    ...
    %>
        ...
        <th><font color="black">rescription</th>
    ...
    <tr>
         ...
         <th><a href="adminexchange1.jsp?username=<%=rs1.getString("username")%>&mobile=<%=rs1.getString("mobile")%>>">Conform Order</a></th>
    </tr>
            <%
                }
                } catch (Exception e) {
