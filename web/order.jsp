...
<link href="templatemo_style.css" rel="stylesheet" type="text/css" />
    ...
    <script>alert('Exchanged Details Sent to Admin Successfully');</script>
    <%}
...
%>
	...
	<div id="content_right">
            <div class="right_col_section_w650">
                <center><div class="header_01">Conformed Orders</div></center>
        <br>
    ...
    %>
        ...
        <th><font color="black">No.of Sheets</th>
        <th><font color="black">Conformation</th>
    ...
    <tr>
         ...
         <th><a href="exchange.jsp?username=<%=rs1.getString("username")%>&mobile=<%=rs1.getString("mobile")%>&email=<%=rs1.getString("email")%>&address=<%=rs1.getString("address")%>&sheets=<%=rs1.getString("sheets")%>">Exchange Order</a></th>
    </tr>
            <%
                }
                } catch (Exception e) {
