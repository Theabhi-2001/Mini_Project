...
%>
	...
	<div id="content_right">
            <div class="right_col_section_w650">
                <center><div class="header_01">Hospital Details</div></center>
        <br>
    ...
    String hname = request.getParameter("hname");
        try {
        PreparedStatement ps = connection.prepareStatement("select * from hospitals where category = '"+hname+"'");
        ResultSet rs1 = ps.executeQuery();

    %>
        <center><table border="2" width="100%">
        <tr style="background-color: grey">
        <th><font color="black">Hospital Name</th>
    ...
    <tr>
         ...
         <%--    <th><a href="userdetails.jsp"><font color="black">View Details</font></a></td> --%>
    </tr>
            <%
                }
                } catch (Exception e) {
